...
public class Solution
{
    ...
    public static void checkSeason(int mount){
        if (mount<=2 ^ mount==12) System.out.println("зима");
        else if (mount<=5 & mount>=3 ) System.out.println("весна");
        else if (mount<=8 & mount>=6 ) System.out.println("лето");
        else if (mount<=11 & mount>=9 ) System.out.println("осень");
    }
}